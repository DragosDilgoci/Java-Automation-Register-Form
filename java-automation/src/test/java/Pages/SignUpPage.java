...
public class SignUpPage {
    ...
    public void registerNewUser(String username, String password, String confirmationPassword, String gender,
                                String firstName, String lastName, String email, String dateOfBirth, String nationality, boolean termAndConditionSelected ) {
...
//                return isEmailValid(email);
            case "submit":
                String termsAndConditions = termsAndConditionsCheckBox.getAttribute("selected");
            default:
                return false;
        }
    }
